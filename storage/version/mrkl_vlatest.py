...
class BR18_Database:
    ...
    def create_vectorstore(self, index_path="faiss_index"):
        if os.path.exists(index_path):
            ...
            project_vectorstore = FAISS.load_local(index_path, self.embeddings)
            st.write("Loaded vectorstore from disk.")
        else:
            ...
            project_vectorstore.save_local(index_path)
...
class MRKL:
    ...
    def load_tools(self):
        ...
        br18_folder_path = os.path.join(current_directory, "BR18")
        index_path = os.path.join(br18_folder_path, "faiss_index")
        llm_br18 = BR18_Database(llm=llm, folder_path=br18_folder_path, index_path=index_path)  # Replace with your folder path
