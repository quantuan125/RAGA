...
class DBStore:
    ...
    def generate_description(self, doc):
        # This is a simple example. You can make it more sophisticated.
        first_line = doc.split('\n')[0]
        return f"useful for answering questions related to: {first_line[:100]}..."
...
class DatabaseTool:
    ...
    def run(self, query: str):
        ...
        st.session_state.doc_sources = [output['source_documents'][0]] if output['source_documents'] else []
